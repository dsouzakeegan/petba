...
img="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Pet-rebbit-on-Swing_%28seat%29-in-beijing.jpg/330px-Pet-rebbit-on-Swing_%28seat%29-in-beijing.jpg"
  ...
  pet:addForm|any={dob:"",name:"",gender:'',color:'',address:'',c_id:'',img1:'',img2:'',img3:'',img4:'',img5:'',img6:'',animalName:"",note:'',anti_rbs:'',viral:'',city:'',long:74.1240,lat:15.2993,animal:'',city_id:'',breed:'',breedName:''};
 Type:any;
